...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=None):
        self.get_rois_from_seg_flag = False
        self.class_specific_seg_flag = False

        #########################
        #    Preprocessing      #
        #########################
        # pp_dir is preprocessed dir
        self.root_dir = '/home/cg/medicaldetectiontoolkit'
        self.raw_data_dir = os.path.join(self.root_dir, 'tooth_dataset/train/')
        self.pp_dir = os.path.join(self.root_dir, 'tooth_dataset/preprocessing/')
        ...
        self.num_epochs = 500 #100
        self.num_train_batches = 3 if self.dim == 3 else 5
        self.batch_size = 3 if self.dim == 3 else 2

        self.do_validation = True # False
        # decide whether to validate on entire patient volumes (like testing) or sampled patches (like training)
        # the former is morge accurate, while the latter is faster (depending on volume size)
        self.val_mode = 'val_sampling' # val_sampling # one of 'val_sampling' , 'val_patient'
        ...
        self.save_n_models = 5 # 5
        self.test_n_epochs = 5 # 5
